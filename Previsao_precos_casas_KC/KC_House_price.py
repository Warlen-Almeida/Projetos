...
fig = px.scatter(df, x="sqft_living", y='price', trendline = 'ols', trendline_color_override = '#892721', template = 'plotly_dark',labels={
    ...
    color_discrete_sequence=['#e1cc55', '#00224e'],
    title ='Preço mediano das casas de acordo com a área interna'
 )
layout(fig) 
...
fig = px.bar(df_view, x="view", 
             ...
             labels={
                     'price': 'Preço das casas',
                      'view': 'Vista da casa'}, 
             title ='Preço mediano das casas de acordo com o nivel da vista'
 )
layout(fig)
...
fig = px.bar(df_bedrooms, x="bedrooms", 
             ...
             title ='Preço mediano das casas de acordo com o número de quartos'
 )
layout(fig)
...
fig = px.bar(df_condition, x="condition", 
             ...
             title ='Preço mediano das casas de acordo com a condição'
 )
layout(fig)
